...
const staticData = [
  { userImage: "DarshanNagaraj.svg", userTitle: "Co-Founder & CPO",userLink: "https://www.linkedin.com/in/darshan33/"},
  { userImage: "KartikKulkarni.svg", userTitle: "Co-Founder & CEO",userLink: "https://www.linkedin.com/in/kulkarnikartik/"},
  { userImage: "KrisInapurapu.svg", userTitle: "Co-Founder & COO",userLink: "https://www.linkedin.com/in/krisinapurapu/"},
];
...
const defaultSection = {
  ...
  co_founder1_userTitle: "",
  co_founder1_userLink: "",

  co_founder2_name: "",
  co_founder2_description: "",
  co_founder2_userTitle: "",
  co_founder2_userLink: "",

  co_founder3_name: "",
  co_founder3_description: "",
  co_founder3_userTitle: "",
  co_founder3_userLink: "",
};
// Define the props interface for the component
interface TestaboutColumnOneProps {
  fetchedSection: any; // You can define a more specific type if needed
}
export default function TestaboutColumnOne({ fetchedSection }: TestaboutColumnOneProps) {
            ...
            setFounders([
              {
                ...
                userTitle: fetchedSection.co_founder1_userTitle ?? defaultSection.co_founder1_userTitle,
                userLink: fetchedSection.co_founder1_userLink ?? defaultSection.co_founder1_userLink,
              },
              {
                ...
                userTitle: fetchedSection.co_founder2_userTitle ?? defaultSection.co_founder2_userTitle,
                userLink: fetchedSection.co_founder2_userLink ?? defaultSection.co_founder2_userLink,
              },
              {
                ...
                userTitle: fetchedSection.co_founder3_userTitle ?? defaultSection.co_founder3_userTitle,
                userLink: fetchedSection.co_founder3_userLink ?? defaultSection.co_founder3_userLink,
              },
            ]);
            setLoading(false);
  ...
  return (
    <div className="flex flex-col items-center md:mt-[13px]">
      <div className="container-xs flex flex-col items-center gap-[104px] lg:gap-[104px] lg:px-5 md:gap-[52px] md:px-[30px] sm:gap-[35px] max-w-[100%] px-[140px]">
        {/* Section Titles */}
        ...
        {/* Co-Founder Profiles */}
        <div className="flex gap-[70px] md:gap-[53px] self-stretch md:flex-wrap justify-center">
            ...
            {loading ? (
              ...
              founders.map((founder, index) => (
                <UserProfile
                  ...
                  // userLink={staticData[index]?.userLink || "/"}
                  userLink={founder.userLink || "/"}
                  userTitle={founder.userTitle || "/"}
