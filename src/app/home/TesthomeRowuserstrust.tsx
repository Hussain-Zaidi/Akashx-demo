    ...
    export default function TesthomeRowuserstrust() {
      ...
      useEffect(() => {
        const fetchData = async () => {
          try {
            const response = await fetch("//64.227.101.114/api/akashx-home-pages");
      ...
      return (
        <div className="flex flex-col items-center justify-center bg-gray-900 pt-[120px] pb-[120px] lg:py-8 md:py-5 md:py-4 mb-10 mt-0 md:mt-[-20px] md:mb-[78px]">
          <div className="container-xs flex flex-col items-center gap-[126px] lg:gap-[32px] lg:px-5 md:gap-[50px] md:px-5 md:gap-9">
            ...
            <div className="relative w-full h-[300px] md:h-[320px] overflow-hidden flex justify-center items-center">
              {[...Array(totalSlides)].map((_, index) => {
                ...
                if(isMobile){
                  ...
                  return (
                    <div
                      key={index}
                      className={`max-w-[1310px] m-auto flex-shrink-0 flex w-full items-center gap-[58px] md:gap-[15px] md:flex-col absolute transition-all duration-1000`}
                      style={{
            ...
            {/* Navigation Dots */}
            <div className="flex justify-center gap-3 md:mt-[-20px] mt-[18px]">
              {[...Array(totalSlides)].map((_, index) => (
                <button
                  key={index}
