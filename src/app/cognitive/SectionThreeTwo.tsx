              ...
              <div className="shadow-[0_0_2.5rem_0_#75BAFF33] md:shadow-[0_0_1rem_0_#75BAFF33] rounded-[2.5rem] md:rounded-[1.25rem]  bg-[linear-gradient(180deg,#5439CC_50%,#30D5C8)] p-2 md:p-1 ">
                ...
                <div className="bg-[#080C26] p-[0_3.5rem] md:p-4 rounded-[2.5rem] md:rounded-[1.25rem] shadow-[0_0_3.4375rem_0_#75BAFF33] md:shadow-[0_0_1.5rem_0_#75BAFF33] h-[19.9168rem] md:h-[10rem] md:flex md:flex-col">
                  ...
                  <div className="flex items-start md:flex-1 justify-between gap-7 md:gap-3">
                    ...
                    <div className="self-end bg-[linear-gradient(135deg,#7657ff9f,#080c26_70%)] p-[1px] rounded-[0.625rem] md:rounded-[0.5rem] overflow-hidden opacity-80 flex-[0_0_8.9rem] w-[8.9rem] h-[8.9rem] md:flex-[0_0_3.125rem] md:w-[3.125rem] md:h-[3.125rem]" >
                    <div className="bg-[#080c26] rounded-[0.625rem] md:rounded-[0.5rem]" >
                      <img
                        className="self-end bg-[linear-gradient(135deg,#2B7FFF33_20%,#080d26_60%)] flex-[0_0_8.9rem] w-[8.9rem] h-[8.9rem] md:flex-[0_0_3.125rem] md:w-[3.125rem] md:h-[3.125rem] md:py-[.5rem] pointer-events-none select-none py-[2.15rem] rounded-[0.625rem] md:rounded-[0.5rem]"
