      ...
      >
        ...
        <div className="border border-[#2B7FFF4D] rounded-[1.5rem] md:rounded-[0.75rem] bg-[#070A20] p-[0_3.5831rem] md:p-[0_1.25rem] flex flex-col items-center">
          <div className="flex w-full gap-14 md:gap-0 md:flex-col items-center">
            ...
            <div className="h-[36rem] w-[0.125rem] md:h-[1px] md:w-full md:h-[0.125rem] bg-[linear-gradient(0deg,#41668C1A,#588BBF99,#41668C1A)] md:bg-[linear-gradient(90deg,#41668C1A,#588BBF99,#41668C1A)]"></div>
          ...
          <div className="w-full h-[0.125rem] md:h-[1px] bg-[linear-gradient(90deg,#41668C1A,#588BBF99,#41668C1A)]"></div>
