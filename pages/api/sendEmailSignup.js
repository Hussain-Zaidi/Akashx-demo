  ...
  if (req.method === "POST") {
    ...
    try {
      ...
      const mailOptions = {
        ...
        subject: "User Requested to Sign Up for Quarter Challenge", // Subject
        text: `A user with email ${email} requested for the quarter cost challenge.`, // Plain text body
        html: `
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
          <p>Hello,</p>
          <p>A user with email <a href="mailto:${email}" style="color: #007BFF; text-decoration: none;">${email}</a> requested for the quarter cost challenge.</p>
